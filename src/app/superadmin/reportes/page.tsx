    ...
    consignaciones.forEach((c) => {
      ...
      soportes.forEach((soporte, index) => {
        ...
        worksheet.addRow({
          ...
          banco: cuenta?.banco || soporte.otraCuenta?.banco || '',
          tipoCuenta: cuenta?.tipoCuenta || soporte.otraCuenta?.tipoCuenta || '',
          numeroCuenta: cuenta?.numeroCuenta || soporte.otraCuenta?.numeroCuenta || '',
          titular: cuenta?.titular || soporte.otraCuenta?.titular || '',
